...
func kubeAPIServerArgs(ip string, etcdIPs []string) []string {
	...
	return []string{
		...
		"--kubelet-certificate-authority", tlsIO.CACertPath(cliPath.MinionTLSDir),
		"--kubelet-client-certificate", tlsIO.SignedCertPath(cliPath.MinionTLSDir),
...
func kubeControllerManagerArgs() []string {
	return []string{
		...
		"--service-account-private-key-file", tlsIO.SignedKeyPath(cliPath.MinionTLSDir),
